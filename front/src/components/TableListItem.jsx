...
export function TableListItem(props) {
    ...
    useEffect(() => {
        getRequest(subUrl).then((response) => {
    ...
    const handleGoToEdit = (itemData) => {
        navigate(`/home/${localStorage.getItem('petdiniz-token').split('.')[1]}/${subUrl.substring(0, subUrl.length - 2)}/${itemData.id}`)
    }
